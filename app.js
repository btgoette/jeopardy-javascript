...
loadQuestions().then(() => {
  ...
  const rd1Questions = questions.filter(function (el) {
    return el.round === "Jeopardy!";
  });
  ...
  let c1Questions = rd1Questions.filter(function (el) {
    return el.category === cat1;
  });

  //   filter first $200 question
  let cat1200 = c1Questions.filter(function (el) {
    return el.value === "$200";
  });
  ...
  let cat11000 = c1Questions.filter(function (el) {
    return el.value === "$500" || el.value === "$1000";
  });
  ...
  let c2Questions = rd1Questions.filter(function (el) {
    return el.category === cat2;
  });

  let cat2200 = c2Questions.filter(function (el) {
    return el.value === "$200";
  });
  ...
  let cat21000 = c2Questions.filter(function (el) {
    return el.value === "$500" || el.value === "$1000";
  });
  ...
  let c3Questions = rd1Questions.filter(function (el) {
    return el.category === cat3;
  });

  let cat3200 = c3Questions.filter(function (el) {
    return el.value === "$200";
  });
  ...
  let cat31000 = c3Questions.filter(function (el) {
    return el.value === "$500" || el.value === "$1000";
  });
  ...
  let c4Questions = rd1Questions.filter(function (el) {
    return el.category === cat4;
  });

  let cat4200 = c4Questions.filter(function (el) {
    return el.value === "$200";
  });
  ...
  let cat41000 = c4Questions.filter(function (el) {
    return el.value === "$500" || el.value === "$1000";
  });
  ...
  let c5Questions = rd1Questions.filter(function (el) {
    return el.category === cat5;
  });

  let cat5200 = c5Questions.filter(function (el) {
    return el.value === "$200";
  });
  ...
  let cat51000 = c5Questions.filter(function (el) {
    return el.value === "$500" || el.value === "$1000";
  });
  ...
  let c6Questions = rd1Questions.filter(function (el) {
    return el.category === cat6;
  });

  let cat6200 = c6Questions.filter(function (el) {
    return el.value === "$200";
  });
  ...
  let cat61000 = c6Questions.filter(function (el) {
    return el.value === "$500" || el.value === "$1000";
  });
